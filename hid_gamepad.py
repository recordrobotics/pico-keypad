...
class Gamepad:
    ...
    numbered 1-32, and one joystick, controlling
    ``x` and ``y`` values
    ...
    def __init__(self, devices):
        ...
        # report[4-5] joystick 0 x: -32768 to 32767
        # report[6-7] joystick 0 y: -32768 to 32767
    ...
    def _send(self, always=False):
        ...
        """
        struct.pack_into(
            "<Ihh", self._report, 0, self._buttons_state, self._joy_x, self._joy_y
        )
